...
class Uploader
{
    ...
    {
        $prefix = str_replace(yii::getAlias(yii::getAlias('@image')), '', yii::getAlias('@ueditor'));
        $domain = Yii::$app->params['image'];
        return array(
            "state" => $this->stateInfo,
            "url" => $domain.$prefix . $this->fullName,
            "title" => $this->fileName,
    ...
    public function qiniu()
    {
    	...
    	$upload->putFile($token, '/ueditor'.$this->fullName, $this->filePath);
    }
}