...
<div class="fileinput fileinput-new" >
    <div style="margin-bottom:10px;">
        <span class="btn red btn-outline btn-file">
            <input type="file" class="default uploadImages<?=$saveDB?>" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" />
        </span>
    ...
    <div class="fileupload-list">
        ...
        <?php foreach($data as $g): ?>
            ...
            <div class="fileupload-item thumbnail">
                <img src="<?=\common\helpers\Html::src(Yii::$app->params['image'].$picture['path'])?>" />
                    ...
                    success: function(json){
                        if(json.boo){
                            var html  = '';
                                ...
                                html += '    <img src="<?=Yii::$app->params['image']?>'+ json.data.url +'" />';
