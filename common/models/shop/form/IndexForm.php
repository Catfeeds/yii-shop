...
use common\models\shop\HomeBlock;
use common\models\shop\HomeNav;
use common\models\shop\SeckillGoods;
use common\models\shop\Option;
use common\models\shop\PtGoods;
use common\models\shop\PtOrder;
use common\models\shop\PtOrderDetail;
use common\models\shop\Store;
use common\models\shop\Topic;
