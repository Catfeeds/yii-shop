 ...
 */
class PtOrderComment extends Model
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'order_id', 'order_detail_id', 'goods_id', 'user_id', 'is_hide', 'is_delete', 'addtime'], 'integer'],
            [['score'], 'number'],
            [['pic_list'], 'string'],
    ...
    static public function getCount($goods_id = 0,$store_id)
    {
